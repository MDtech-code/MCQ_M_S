    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, default='', help_text='E.164 formatted international number', max_length=20, unique=True, validators=[apps.accounts.validators.validate_phone_number], verbose_name='phone number')),
