    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, help_text='E.164 formatted international number', max_length=20, null=True, unique=True, validators=[apps.accounts.validators.validate_phone_number], verbose_name='phone number')),
